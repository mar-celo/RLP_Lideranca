...
grafico_3.1 <- tab_3.1 %>%
  ...
  geom_text(aes(label = abs(Total)), vjust = -100, nudge_y = 20, size = 3, color = "black") +  # Ajustando a posição e tamanho dos rótulos de dados
...
grafico_3.2 <- tab_3.2 %>%
  ...
  geom_bar(stat = "identity") +
  geom_text(aes(label = paste0(abs(Percentual*100), "%")), size = 3, color = "black") +  # Ajustando a posição e tamanho dos rótulos de dados
  scale_fill_manual(values = c("#004580", "#ffaf51")) +
...
grafico_3.3 <- tab_3.3 %>%
  ...
  geom_text(aes(label = paste0(abs(Percentual*100), "%")),  size = 3, color = "black") +
...
grafico_3.3 <- grafico_3.3 +
  labs(
    title = "Gráfico 3 – Percentual de ocupação de cargos de liderança em junho/2019",
    x="",
    y = "",
    fill = '',
    caption = "\n\nFonte: https://www.gov.br/servidor/pt-br/observatorio-de-pessoal-govbr/serie-relatorios-gerenciais-genero"
...
grafico_3.4 <- grafico_3.4 +
  labs(
    title = "Gráfico 4 – Percentual de ocupação de cargos de liderança em junho/2023",
    x="",
    y = "",
    fill = "",
    caption = "\n\nFonte: https://www.gov.br/servidor/pt-br/observatorio-de-pessoal-govbr/serie-relatorios-gerenciais-genero"
...
grafico_3.5 <- grafico_3.5 +
  labs(
    title = " Gráfico 5 – Percentual de líderes com filhos menores de idade (junho/2023)",
    x="",
    y = "",
    fill = "",
        caption = "\n\nFonte: https://www.gov.br/servidor/pt-br/observatorio-de-pessoal-govbr/serie-relatorios-gerenciais-genero"
...
grafico_3.7 <- ggplot(tab_3.7) +
  ...
  geom_col(width = 0.4) +
  scale_fill_manual(values = c("#f9a830", "#ac670c", "#f2aa49", "#4122d9","#dfdfdf", "#0f04fc")) +
  scale_y_continuous(breaks=seq(0,1,0.2),
                     #limits = c(0, 1),
                     labels=paste0(abs(seq(0,100,20)), "%"))+
  coord_flip() +
...
grafico_3.8 <- ggplot(tab_3.8) +
 ...
 # geom_text(aes(label = Média),hjust = -0.5, size = 3, color = "black") +
  scale_fill_manual(values = c("#ffaf51","#004580"))+
...
Sistema Integrado de Administração de Pessoal (SIAPE) e no [**Painel
Estatístico de Pessoal
(PEP).**](http://painel.pep.planejamento.gov.br){target="_blank"}
